...
public class ItemGrabacion {
    ...
    static {
        ...
        addItem(new ItemGrabacion.itemGab("2","Grabacion1",R.drawable.musica,"Grabacion1.m4a"));
        addItem(new ItemGrabacion.itemGab("3","Grabacion2", R.drawable.musica,"Grabacion2.m4a"));
        addItem(new ItemGrabacion.itemGab("4","Grabacion3", R.drawable.musica,"Grabacion3.m4a"));
        addItem(new ItemGrabacion.itemGab("5","Grabacion4", R.drawable.musica,"Grabacion4.m4a"));
    }
